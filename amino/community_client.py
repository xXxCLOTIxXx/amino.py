...
class CommunityClient(Client):
	...
	***server settings***
	...
	def __init__(self, comId: int = None, community_link: str = None, aminoId: str = None, profile: profile = None, language: str = "en", user_agent: str = "Apple iPhone12,1 iOS v15.5 Main/3.12.2", auto_user_agent:  bool = False, deviceId: str = None, auto_device: bool = False, proxies: dict = None, certificate_path = None):
