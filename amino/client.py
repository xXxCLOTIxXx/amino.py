...
from .helpers.generator import generate_deviceId
...
class Client(Socket):
	...
	def __init__(self, deviceId: str = None, language: str = "en", user_agent: str = "Apple iPhone12,1 iOS v15.5 Main/3.12.2", verify = None, proxies: dict = None, socket_enable: bool = True, sock_trace: bool = False, sock_debug: bool = False):
	...
	def login(self, email: str, password: str = None, secret: str = None) -> dict:
