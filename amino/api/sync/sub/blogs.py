...
class CommunityBlogsModule(BaseClass):
	...
	def post_blog(self, title: str, content: str, imageList: list | None = None, captionList: list | None = None, categoriesList: list | None = None, backgroundColor: str | None = None, fansOnly: bool = False, extensions: dict | None = None):
		...
		**Parameters**:
		...
		return self.req.make_sync_request("POST", f"/x{self.comId}/s/blog", data).json()
	...
	def post_wiki(self, title: str, content: str, icon: str | None = None, imageList: list | None = None, keywords: str | None = None, backgroundColor: str | None = None, props: list | None = None, backgroundMediaList: list | None = None):
		...
		**Parameters**:
		...
		return self.req.make_sync_request("POST", f"/x{self.comId}/s/item", data).json()
	...
	def edit_blog(self, blogId: str, title: str | None = None, content: str | None = None, imageList: list | None = None, categoriesList: list | None = None, backgroundColor: str | None = None, fansOnly: bool = False):
		...
		**Parameters**:
		...
		return self.req.make_sync_request("POST", f"/x{self.comId}/s/blog/{blogId}", data).json()
	...
	def delete_blog(self, blogId: str):
		...
		**Parameters**:
		- blogId: str
		"""
		return self.req.make_sync_request("DELETE", f"/x{self.comId}/s/blog/{blogId}").json()
	...
	def delete_wiki(self, wikiId: str):
		...
		**Parameters**:
		- wikiId: str
		"""
		return self.req.make_sync_request("DELETE", f"/x{self.comId}/s/item/{wikiId}").json()
	...
	def play_quiz_raw(self, quizId: str, quizAnswerList: list, quizMode: int = args.QuizMode.NormalMode):
		"""
		Send quiz results.
		...
		**Parameters**
		...
		return self.req.make_sync_request("POST", f"/x{self.comId}/s/blog/{quizId}/quiz/result", data).json()

	def play_quiz(self, quizId: str, questionIdsList: list, answerIdsList: list, quizMode: int = args.QuizMode.NormalMode):
		"""
		Send quiz results.
	...
	def get_user_blogs(self, userId: str, start: int = 0, size: int = 25):
		...
		**Parameters**
		...
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/blog?type=user&q={userId}&start={start}&size={size}").json()["blogList"]
	...
	def get_user_wikis(self, userId: str, start: int = 0, size: int = 25):
		...
		**Parameters**
		...
		- size : Size of the list.
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/item?type=user-all&start={start}&size={size}&cv=1.2&uid={userId}").json()["itemList"]
	...
	def get_saved_blogs(self, start: int = 0, size: int = 25):
		...
		**Parameters**
		...
		- size : Size of the list.
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/bookmark?start={start}&size={size}").json()["bookmarkList"]
	...
	def get_wiki_info(self, wikiId: str):
		...
		**Parameters**
		- wikiId: wiki id
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/item/{wikiId}").json()
	...
	def get_recent_wiki_items(self, start: int = 0, size: int = 25):
		...
		**Parameters**
		...
		- size : Size of the list.
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/item?type=catalog-all&start={start}&size={size}").json()["itemList"]
	...
	def get_wiki_categories(self, start: int = 0, size: int = 25):
		...
		**Parameters**
		...
		- size : Size of the list.
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/item-category?start={start}&size={size}").json()["itemCategoryList"]
	...
	def get_wiki_category(self, categoryId: str, start: int = 0, size: int = 25):
		...
		**Parameters**
		...
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/item-category/{categoryId}?pagingType=t&start={start}&size={size}").json()
	...
	def get_blog_info(self, blogId: str | None = None, wikiId: str | None = None, quizId: str | None = None, fileId: str | None = None):
		...
		**Parameters**
		...
		"""
		if blogId or quizId:
			return self.req.make_sync_request("GET", f"/x{self.comId}/s/blog/{blogId or quizId}").json()
		elif wikiId:
			return self.req.make_sync_request("GET", f"/x{self.comId}/s/item/{wikiId}").json()
		elif fileId:
			return self.req.make_sync_request("GET", f"/x{self.comId}/s/shared-folder/files/{fileId}").json()["file"]
		raise SpecifyType
	...
	def get_blog_categories(self, size: int = 25):
		...
		**Parameters**
		...
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/blog-category?size={size}").json()["blogCategoryList"]
	...
	def get_blogs_by_category(self, categoryId: str,start: int = 0, size: int = 25):
		...
		**Parameters**:
		...
		- size : Size of the list.
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/blog-category/{categoryId}/blog-list?start={start}&size={size}").json()["blogList"]
	...
	def get_quiz_rankings(self, quizId: str, start: int = 0, size: int = 25):
		...
		**Parameters**:
		...
		- size : Size of the list.
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/blog/{quizId}/quiz/result?start={start}&size={size}").json()
	...
	def get_recent_blogs(self, pageToken: str | None = None, start: int = 0, size: int = 25):
		...
		**Parameters**
		...
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/feed/blog-all?pagingType=t&size={size}{f'&pageToken={pageToken}' if pageToken else  f'&start={start}'}").json()
	...
	def get_shared_folder_info(self):
		...
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/shared-folder/stats").json()["stats"]

	def get_shared_folder_files(self, type: str = args.Sorting2.Latest, start: int = 0, size: int = 25):
		"""
		...
		**Parameters**
		...
		"""
		return self.req.make_sync_request("GET", f"/x{self.comId}/s/shared-folder/files?type={type}&start={start}&size={size}").json()["fileList"]
